...
def average(region):
    ...
    red = np.mean(region[:, :, 0])  # Average of red channel
    green = np.mean(region[:, :, 1])  # Average of green channel
    blue = np.mean(region[:, :, 2])  # Average of blue channel
...
def setRegion(region, r, g, b):
    ...
    region[:, :, 0] = r  # Set red channel
    region[:, :, 1] = g  # Set green channel
    region[:, :, 2] = b  # Set blue channel
